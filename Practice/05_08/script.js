...
console.log(document.querySelector(".backpack__volume").classList.add("new-class"))
console.log(document.querySelector(".backpack__volume").classList.remove("new-class"))
console.log(document.querySelector(".backpack__volume").classList.replace("feature","new"))


console.log(document.querySelector(".backpack__color").setAttribute("style","color:blue;"))
console.log(document.querySelector(".backpack__color").removeAttribute("style"))

console.log(document.querySelector(".backpack__color").style.backgroundColor ="blue")
